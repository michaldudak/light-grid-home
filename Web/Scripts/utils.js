(function() {
	...
	var utils = angular.module("lightGridHomeUtils", []);

	utils.directive("highlight", function () {
		return {
			restrict: "A",
			link: function ($scope, $elem, $attrs) {
				var language = $attrs.highlight;
				$elem.addClass("lang-" + language);
	...
	utils.directive("sourceDisplay", ["$compile", function ($compile) {
		return {
